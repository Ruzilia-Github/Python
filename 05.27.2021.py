...
#     count +=1 # количество цифр в нем;
#     mult *= last# произведение его цифр;
#     average = sum_d / count# среднее арифметическое его цифр;
#     n=n//10
# sum_last_first = first + last# сумму его первой и последней цифры.
# print(sum_d)
# print(count)
# print(mult)
# print(average)
